-- SQLCMD entry point compatible with both Docker (Linux) and SSMS (Windows)
-- For SSMS execution, change SqlRoot below to: C:\Users\Dell\OneDrive\HotelDesk-ASPNET-Blazor\sql
:setvar SqlRoot "."
:on error exit
...
:r $(SqlRoot)/product/procedures/sp_DatPhong_BaoVe.sql
:r $(SqlRoot)/procedures/sp_DatPhong_Deadlock.sql
:r $(SqlRoot)/procedures/sp_TraPhongDemo.sql
:r $(SqlRoot)/procedures/sp_TraCuuPhongDemo.sql
:r $(SqlRoot)/procedures/sp_Demo_NonRepeat_Phantom.sql
:r $(SqlRoot)/product/procedures/sp_Deadlock_KB2_ThanhToan_BaoCao.sql